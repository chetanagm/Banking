    ...
    <div id="main-wrapper">
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <div class="user-profile" style="background: url(assets/images/background/user-info.jpg) no-repeat;">
                    <!-- User profile image -->
                    <div class="profile-img"> <img src="assets/images/pp.png" alt="user" /> </div>
                    <!-- User profile text-->
                ...
                <!-- Sidebar navigation-->
                    ...
                    <option>
                    <ul id="sidebarnav">
                         <li> <a class=" waves-effect waves-dark" href="transaction" ><i class="mdi mdi-gauge"></i><span class="hide-menu">Transaction Details </span>
                        </li>
                    </ul>
                </option>
                    </section>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <%if(user.getActive()==0){
                %>
                    <input type="text" name="active_value" value="0">
                <% 
                }
                %>
