...
<%@ page import="com.mccoy.dto.RegistrationDTO" %>
<%@ page import="com.mccoy.dto.TransactionDTO"%>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)"><%=user.getName()%></a></li>
		...
		<div class="table-responsive m-t-40">
			<table id="myTable" class="table table-bordered table-striped">
				...
				<%for (TransactionDTO transactionDTO : transactions) {%>
					<tr>
						<td><%=transactionDTO.getTransaction_Id()%></td>
						<td><%=transactionDTO.getCreated_on()%></td>
						<td><% if(transactionDTO.getTransaction_type().equalsIgnoreCase("debited")){%>
						<%=transactionDTO.getTransaction_amount()%><%}%></td>
						<td><%if(transactionDTO.getTransaction_type().equalsIgnoreCase("credited")){%>
							<%=transactionDTO.getTransaction_amount()%><%}%></td>
						<td><%=transactionDTO.getBalance()%></td>
					</tr>
					<%}%>
				</tbody>
			</table>
